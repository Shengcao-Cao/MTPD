...
distiller = dict(
    ...
    teacher_pretrained = 'checkpoints/retinanet_r101_fpn_mstrain_3x_coco_20210720_214650-7ee888e0.pth',
    init_student = True,
...
teacher_cfg = 'configs/retinanet/retinanet_r101_fpn_mstrain_640-800_3x_coco.py'
