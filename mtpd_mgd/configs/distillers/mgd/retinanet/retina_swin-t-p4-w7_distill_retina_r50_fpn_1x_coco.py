...
distiller = dict(
    ...
    teacher_pretrained = 'checkpoints/retinanet_swin-t-p4-w7_fpn_fp16_ms-crop-3x_coco-db1f3f49.pth',
    init_student = True,
...
teacher_cfg = 'configs/swin/retinanet_swin-t-p4-w7_fpn_fp16_ms-crop-3x_coco.py'
